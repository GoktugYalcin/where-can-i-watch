...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      ...
      >
        <div
          className={`z-10 scale-110 lg:scale-100 w-full max-w-5xl flex-col items-center justify-center lg:text-5xl text-2xl font-semibold text-center lg:flex ${inconsolata.className}`}
        >
